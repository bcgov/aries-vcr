    ...
    def run(self, target, payload, instance_id=None, hook_id=None, **kwargs):
        ...
        try:
            ...
            try:
                ...
                """
                print("Error sending hook to:", payload["subscription"])
                print("Credential Type:", payload["data"]["credential_json"]["schema_name"])
                print("Credential:", payload["data"]["credential_json"]["attributes"])
